import { ToggleMenuButton } from "@/components/templates/ToggleMenuButton";
import { useMenu } from "@/hooks/UseMenu";
import { cn } from "@/lib/utils";
import { Link } from "react-router-dom";

export const CenteredMenu = (props: { logo: React.ReactNode; children: React.ReactNode; rightMenu: React.ReactNode }) => {
